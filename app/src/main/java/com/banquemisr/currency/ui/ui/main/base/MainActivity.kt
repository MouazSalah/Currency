package com.banquemisr.currency.ui.ui.main.base
...
import com.areeb.moviesexplorer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), NavController.OnDestinationChangedListener {
    ...
    override fun onDestinationChanged(
        ...
        if (destination.id == R.id.moviesListFragment) {
